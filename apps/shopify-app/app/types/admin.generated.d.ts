...
export type GetShopQuery = { shop: (
    ...
    & { primaryDomain: Pick<AdminTypes.Domain, 'url'>, plan: Pick<AdminTypes.ShopPlan, 'displayName' | 'partnerDevelopment' | 'shopifyPlus'> }
  ) };

export type GetThemesQueryVariables = AdminTypes.Exact<{
  first?: AdminTypes.InputMaybe<AdminTypes.Scalars['Int']['input']>;
  roles?: AdminTypes.InputMaybe<Array<AdminTypes.ThemeRole> | AdminTypes.ThemeRole>;
}>;


export type GetThemesQuery = { themes?: AdminTypes.Maybe<{ nodes: Array<Pick<AdminTypes.OnlineStoreTheme, 'id'>> }> };
